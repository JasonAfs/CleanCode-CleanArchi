...
export abstract class BaseAuthorizationRule implements IAuthorizationRule {
    ...
    protected hasRequiredContext(context: AuthorizationContext, requiredFields: (keyof AuthorizationContext)[]): boolean {
        return requiredFields.every(field => 
            Object.hasOwn(context, field) && context[field] !== undefined
        );
    }
}